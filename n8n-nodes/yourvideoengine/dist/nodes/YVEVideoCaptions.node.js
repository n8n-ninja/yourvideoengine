...
class YVEVideoCaptions {
    ...
    async execute() {
        ...
        for (let i = 0; i < items.length; i++) {
            ...
            const optionalStyle = this.getNodeParameter("optionalStyle", i, {});
            ...
            const fontSize = this.getNodeParameter("fontSize", i, 70);
            const fontFamily = this.getNodeParameter("fontFamily", i, "Arial Black");
            const textShadow = this.getNodeParameter("textShadow", i, false);
            const position = this.getNodeParameter("position", i, 75);
