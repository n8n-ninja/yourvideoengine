...
export class YVERenderSample implements INodeType {
  description: INodeTypeDescription = {
    ...
    properties: [
      ...
      },
      {
        ...
        type: "string",
        default: [
          { word: "the", start: 0.16, end: 0.48, confidence: 0.9627397 },
          { word: "most", start: 0.48, end: 0.71999997, confidence: 0.9995771 },
          {
            word: "powerful",
            start: 0.71999997,
            end: 1.04,
          ...
          { word: "to", start: 1.4399999, end: 1.68, confidence: 0.9996848 },
          { word: "automate", start: 1.68, end: 2, confidence: 0.9996444 },
          { word: "your", start: 2, end: 2.24, confidence: 0.99906975 },
          { word: "video", start: 2.24, end: 2.56, confidence: 0.9994635 },
          { word: "production", start: 2.56, end: 2.96, confidence: 0.9990239 },
          { word: "using", start: 2.96, end: 3.28, confidence: 0.99762136 },
          { word: "the", start: 3.28, end: 3.4399998, confidence: 0.9985489 },
          {
            word: "latest",
            start: 3.4399998,
            end: 3.76,
          ...
          { word: "ai", start: 3.76, end: 4.16, confidence: 0.9933907 },
          { word: "technology", start: 4.16, end: 4.64, confidence: 0.9472135 },
        ],
        required: false,
      },
      {
        ...
        type: "string",
        default:
          "https://diwa7aolcke5u.cloudfront.net/uploads/9720d87ed3ef47418eaff1bb8b3af4eb.mp4",
        required: false,
      },
      {
  ...
  async execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
    ...
    for (let i = 0; i < items.length; i++) {
      ...
      const environment = this.getNodeParameter("environment", i) as
        | "dev"
        | "prod"
